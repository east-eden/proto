...
linux_proto:
	# 服务器导出
	./bin/protoc_server -I=./global --go_out=:../server/proto --micro_out=:../server/proto/global --go_opt=module=bitbucket.org/funplus/server/proto --micro_opt=paths=source_relative ./global/*.proto
